...
mcc -v -mv -R -nodisplay -R -singleCompThread       -a ./PALM -a ./PALM/fileio  -I ./PALM -I ./PALM/fileio  ./PALM/palm.m -a './PALM/*.m' -I /home/songx4/fmri/freesurfer/matlab #-a /home/songx4/fmri/freesurfer/matlab
